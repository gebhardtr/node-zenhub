...
Epics.prototype.getEpics = function (repoId) {
    return this._http._get('repositories/' + repoId + '/epics', {});
};
...
Epics.prototype.getEpicData = function (repoId, epicId) {
    return this._http._get('repositories/' + repoId + '/epics/' + epicId, {});
};
...
Epics.prototype.convertIssueToEpic = function (repoId, issueId, payload) {
    return this._http._post('repositories/' + repoId + '/issues/' + issueId + '/convert_to_epic', {}, payload);
};
...
Epics.prototype.convertEpicToIssue = function (repoId, epicId, payload) {
    return this._http._post('repositories/' + repoId + '/epics/' + epicId + '/convert_to_issue', {}, payload);
};
...
Epics.prototype.addRemoveIssuesToEpic = function (repoId, epicId, payload) {
    return this._http._post('repositories/' + repoId + '/epics/' + epicId + '/update_issues', {}, payload);
};
